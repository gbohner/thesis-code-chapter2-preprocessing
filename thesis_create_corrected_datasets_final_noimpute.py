...
stamp_git_save = '_gitsha_' + '2bd0d72' + '_evalgit_db4ade8' + '_noimpute' # Also stamp the updated correction procedure
...
for dataset_name in all_dataset_names:
    ...
    imgsImputed[nanmask] = float(0) # Undo the imputations and keep the zeros (imputation introduces covariance, which messes with CHOMP)
    
    imgsImputed = imgsImputed.to(device)
